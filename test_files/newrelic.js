...
NREUM.loader_config = {
  accountID: document.currentScript.getAttribute('accountid'),
  trustKey: '2046090',
  agentID: document.currentScript.getAttribute('agentid'),
  licenseKey: document.currentScript.getAttribute('licensekey'),
  applicationID: document.currentScript.getAttribute('appid')
};
NREUM.info = {
    beacon: 'bam.nr-data.net',
    errorBeacon: 'bam.nr-data.net',
